...
import (
	...
	wmsrequest "github.com/maxlcoder/homework-backend/app/request/wms_request"
...
func (controller *PickingCarController) Store(c *gin.Context) {
	// 参数处理
	var pickingCarStoreRequest wmsrequest.PickingCarStoreRequest
