...
func NewAdminService(db *gorm.DB, adminRepository repository.AdminRepository, roleRepository repository.RoleRepository, adminRoleRepository repository.AdminRoleRepository) *AdminService {
	return &AdminService{
		db:                  db,
